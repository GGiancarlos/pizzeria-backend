...
public interface OrderRepository extends ListCrudRepository<OrderEntity, Integer> {
    ...
    List<OrderEntity> findAllCustomerOrders(@Param("id") String idCustomer);
    ...
    OrderSummary getOrderSummary(@Param("idOrder") int idOrder);

    @Procedure(value = "take_random_pizza_order", outputParameterName = "order_taken")
    boolean saveRandomOrder(@Param("id_customer") String idCustomer, @Param("method") String method);    // los parametros deben de ser los mismos que el store procedure
}
